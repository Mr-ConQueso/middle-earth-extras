...
public class ModBootsArmorRenderer implements ArmorRenderer {

    private CustomBootsModel<LivingEntity> customBootsModel;

    public ModBootsArmorRenderer() {
    }
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        ...
        if (slot == EquipmentSlot.FEET) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customBootsModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture), dyeable);
        }
    }
}
