        ...
        if (slot == EquipmentSlot.HEAD) {
            ...
            if(hoodDataComponent != null) {
                ...
                if (hoodDataComponent.down()){
                     texture = Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/hood/" + hoodDataComponent.hood().getName().toLowerCase() + "_down.png");
                    ...
                    texture = Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/hood/" + hoodDataComponent.hood().getName().toLowerCase() + ".png");
                ...
                if (ModDyeablePieces.dyeableHoods.containsKey(hoodDataComponent.getHood())) {
                    ...
                    if (ModDyeablePieces.dyeableHoods.get(hoodDataComponent.hood())){
                        ModArmorRenderer.renderTranslucentPiece(matrices, vertexConsumers, light, stack, hoodModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture.getPath().replaceAll(".png", "_overlay.png")));
                    }
                } else {
