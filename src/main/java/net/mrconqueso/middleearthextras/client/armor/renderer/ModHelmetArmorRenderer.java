package net.mrconqueso.middleearthextras.client.armor.renderer;
...
public class ModHelmetArmorRenderer implements ArmorRenderer {
    ...
    public ModHelmetArmorRenderer() {
    }

    public ModHelmetArmorRenderer(HelmetAddonModel<LivingEntity> helmetModel) {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        ...
        if (slot == EquipmentSlot.HEAD) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customHelmetModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture), dyeable);
            ...
            if (this.helmetModel != null) {
                ...
                if(texture.contains("_helmet.png")){
                    ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, this.helmetModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture.replaceAll("_helmet.png", "_addition.png")), dyeable);
                } else {
                    ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, this.helmetModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture.replaceAll(".png", "_addition.png")), dyeable);
                }
            }
            ...
            if(hoodDataComponent != null) {
                ...
                if (hoodDataComponent.down()){
                    textureHood = Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/hood/" + hoodDataComponent.hood().getName().toLowerCase() + "_down.png");
                    ...
                    textureHood = Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/hood/" + hoodDataComponent.hood().getName().toLowerCase() + ".png");
                ...
                if (ModDyeablePieces.dyeableHoods.containsKey(hoodDataComponent.getHood())) {
                    ModHoodRenderer.renderDyeableHood(matrices, vertexConsumers, light, stack, hoodModel, textureHood, true);
                    if (ModDyeablePieces.dyeableHoods.get(hoodDataComponent.hood())){
                        ModArmorRenderer.renderTranslucentPiece(matrices, vertexConsumers, light, stack, hoodModel, Identifier.of(MiddleEarthExtras.MOD_ID, textureHood.getPath().replaceAll(".png", "_overlay.png")));
                    }
                } else {
