...
public class ModChestplateArmorRenderer implements ArmorRenderer {
    ...
    public ModChestplateArmorRenderer() {
    }

    public ModChestplateArmorRenderer(ChestplateAddonModel<LivingEntity> chestplateModel) {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        ...
        if (slot == EquipmentSlot.CHEST) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customChestplateModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture), dyeable);
            ...
            if (this.chestplateModel != null) {
                ...
                ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, this.chestplateModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture.replaceAll("_chestplate.png", "_addition.png")), dyeable);
            }
            ...
            if (capeDataComponent != null) {
                ...
                if (ModDyeablePieces.dyeableCapes.containsKey(capeDataComponent.getCape())) {
                    ModCapeRenderer.renderDyeableCape(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + ".png"), true);
                    if (ModDyeablePieces.dyeableCapes.get(capeDataComponent.cape()).booleanValue()){
                        ArmorRenderer.renderPart(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + "_overlay.png"));
                    }
                } else {
                    ArmorRenderer.renderPart(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + ".png"));
                }}
        }
    }
}
