...
public class ModCapeRenderer implements ArmorRenderer {

    private ChestplateAddonModel<LivingEntity> capeModel;

    public ModCapeRenderer() {
    }
        ...
        if (slot == EquipmentSlot.CHEST) {
            ...
            if (capeDataComponent != null) {
                ...
                if (ModDyeablePieces.dyeableCapes.containsKey(capeDataComponent.getCape())) {
                    renderDyeableCape(matrices, vertexConsumers, light, stack, capeModel, Identifier.of(MiddleEarthExtras.MOD_ID, "textures/models/cape/" + capeDataComponent.cape().getName() + ".png"), false);
