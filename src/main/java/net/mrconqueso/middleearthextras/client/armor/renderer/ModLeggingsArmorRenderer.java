...
public class ModLeggingsArmorRenderer implements ArmorRenderer {

    private CustomLeggingsModel<LivingEntity> customLeggingsModel;

    public ModLeggingsArmorRenderer() {
    }
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        ...
        if (slot == EquipmentSlot.LEGS) {
            ...
            ModArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, customLeggingsModel, Identifier.of(MiddleEarthExtras.MOD_ID, texture), dyeable);
        }
    }
}
