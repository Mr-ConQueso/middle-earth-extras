...
public class ModRaces {
    ...
    public static final RegistryKey<Registry<Race>> MOD_RACE_KEY = RegistryKey.ofRegistry(Identifier.of(MiddleEarth.MOD_ID, "races"));
    ...
    public static void bootstrap(Registerable<Race> context) {
        RegistryEntryLookup<Race> raceRegistryEntryLookup = context.getRegistryLookup(MOD_RACE_KEY);
    ...
    private static Race register(Registerable<Race> context, RegistryEntryLookup<Race> raceRegistryEntryLookup, Race race) {
        ...
        RegistryKey<Race> newRace = RegistryKey.of(MOD_RACE_KEY, Identifier.of(MiddleEarthExtras.MOD_ID, name));
    ...
    private static RegistryKey<Race> of(String name) {
        return RegistryKey.of(MOD_RACE_KEY, Identifier.of(MiddleEarthExtras.MOD_ID, name));
    }

    static {
        BEORNING = new Race(Identifier.of(MiddleEarthExtras.MOD_ID, "beorning"), RaceType.NONE, new AttributeData(new HashMap<RegistryEntry<EntityAttribute>, Double>() {
            {
        ...
        ENT = new Race(Identifier.of(MiddleEarthExtras.MOD_ID, "ent"), RaceType.NONE, new AttributeData(new HashMap<RegistryEntry<EntityAttribute>, Double>() {
            {
                this.put(EntityAttributes.GENERIC_SCALE, (double)1.0F);
                this.put(EntityAttributes.GENERIC_MAX_HEALTH, (double)22.0F);
                this.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, (double)1.0F);
